...
################################# 
	...
	if 'biosample_characterization' in new_object[u'@type'] :
        ...
        if new_object.has_key(u'uuid'):
            ...
            object_uuid = ''
	if new_object.has_key(u'alias'):
            object_alias = str(new_object[u'alias'])
        else:
            object_alias = ''
...
# response = new_ENCODE(object_collection,new_object)
		...
		#	print(object_check[u'@id'], object_check[u'uuid'])
			uploaded_objects.append(object_check)
...
# print(object_id + ' has no updates.')
    ...
    filename = 'uploadedobjects.json'
    print 'Writing '+ str(len(uploaded_objects))+ ' objects to JSON file: '+ filename
    WriteJSON(uploaded_objects,filename)

    errfilename = 'errorobjects.json'
    print 'Writing '+ str(len(error_objects))+ ' objects to JSON file: '+ errfilename
